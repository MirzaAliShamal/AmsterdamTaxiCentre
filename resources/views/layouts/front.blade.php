...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Amsterdam Taxi Centrale | Boek nu uw rit</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="icon" type="image/png" sizes="128x128" href="{{ asset('theme/logo.svg') }}">
        ...
        <link rel="stylesheet" href="{{ asset('theme/css/intlTelInput.css')}}">
        <link rel="stylesheet" href="{{ asset('theme/css/style.css?v1.3') }}">
        <style>
            .from-group {
                margin-bottom: 30px;
            }
    ...
    <body class="theme-1">
        ...
        <!-- custom scripts -->
        <script src="{{ asset('theme/js/intlTelInput.js') }}"></script>
